...
console.log("Connecting Queen Nethu Md bot 🧬");
...
let up = `*Connected Successfull \`QUEEN NETHU MD\` Multidevice Whatsapp Bot ✅*
...
*Github Repo:* https://github.com/Nethu-Md/Nethu-Md
...
if(senderNumber.includes("94741245331")){
if(isReact) return
m.react("👨‍🔬")
}*/
...
app.get("/", (req, res) => {
res.send("QUEEN NETHU MD Bot Started✅");
});
